...
namespace QRbert
{
    public partial class CaptureTheWebcam : Window
    {
        private VideoCapture capture;
        private Timer timer;
        
        public CaptureTheWebcam()
        {
            InitializeComponent();
        ...
        private async void timer_Tick(object sender, ElapsedEventArgs e)
        {
            ...
            this.Dispatcher.Invoke(() =>
            {
                ...
                // copy the bitmap to a memory stream
                ...
                if (!string.IsNullOrEmpty(qrcode))
                {
                    ...
                    TextBlock2.Text =
                        $"Last scan: {DateTime.Now.ToLongDateString()} at {DateTime.Now.ToShortTimeString()}.";
