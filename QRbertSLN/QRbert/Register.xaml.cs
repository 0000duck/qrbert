...
public partial class Register : Page
{
  ...
  string connectionString = @"Data Source = qrbert-rds1; 
...
*/
        ...
        sqlCmd.Parameters.AddWithValue("@Faculty_Role", txtFacultyRole.Text.Trim());
    ...
    void Clear()
    {
        txtFacultyRole.Text = txtFirstName.Text = txtLastName.Text = txtEmail.Text = txtPassword.Text = txtConfirmPassword.Text = "";
    }
